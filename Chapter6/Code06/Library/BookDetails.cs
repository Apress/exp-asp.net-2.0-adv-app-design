...
{	
	...
	{
        private string ConnectionString = "server=.;database=sellylibrary;uid=sa;pwd=123123";
		...
		{
			SqlCommand cm = new SqlCommand("usp_GetBook", new SqlConnection(ConnectionString));
		...
		{
			SqlCommand cm = new SqlCommand("usp_InsertBook",new SqlConnection(ConnectionString));
